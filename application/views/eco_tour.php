                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                echo form_open('Admin/add_eco_tour',$attributes);
                                ?>
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo base_url();?>uploads/eco_tour_images/<?php echo $banner['image_path']?>" width="50px" height="50px"></td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_eco_tour_images', $attributes);
                                                                  ?>
                                                                    
                                                                    <tr>
                                                                      <th><label for="Carousel" class="control-label">Carousel:</label></th>
                                                                      <td>
                                                                        <img src="<?php echo base_url();?>uploads/eco_tour_images/<?php echo $banner['image_path']?>" width="150px" height="150px"> 
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  echo validation_errors();
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_eco_tour_content', $attributes);
                                                                  ?>
                                                                    <tr>
                                                          ...
                                                          <div class="modal fade" id="myModalfaqdelete<?php echo $content['content_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            ...
                                                            <?php
                                                                echo form_open('Admin/delete_eco_tour_content');
                                                                ?>
                                                            <div class="modal-body">
...
<!-----------------------Onload Popup-------------------->
    ...
    ?>
        <script>
        alert("Eco Tour Content has been deleted successfully !");
        </script>
