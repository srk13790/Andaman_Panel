                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Add Trip Planner Content</h4>
                            </div>
                            <div class="modal-body">
                                <?php
                                $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                echo form_open('Admin/add_trip_planner',$attributes);
                                ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control ckeditor" onkeypress="return onlyAlphabetsNumberschar(event,this);" id="editor" name="description" required rows="3" cols="40"></textarea>
                                </div>
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo base_url();?>uploads/trip_planner_images/<?php echo $banner['image_path']?>" width="50px" height="50px"></td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_trip_planner_images', $attributes);
                                                                  ?>
                                                                    
                                                                    <tr>
                                                                      <th><label for="Carousel" class="control-label">Carousel:</label></th>
                                                                      <td>
                                                                        <img src="<?php echo base_url();?>uploads/trip_planner_images/<?php echo $banner['image_path']?>" width="150px" height="150px"> 
                                                                    ...
                                                                    <tr>
                                                                      ...
                                                                      <td>
                                                                        <textarea class="form-control ckeditor" onkeypress="return onlyAlphabetsNumberschar(event,this);" onkeyup="add_image_title(event)" id="editor" name="description" required rows="3" cols="40"><?php echo $banner['description']?></textarea>
                                                                    ...
                                                                    <tr>
                                                                      <th><label for="Description" class="control-label">Description:</label></th>
                                                                      <td><input type="text" class="form-control" onkeypress="return onlyAlphabetsNumberschar(event,this);" onkeyup="add_image_title(this.value,event)" id="image_title" name="description" value="<?php echo $banner['description']?>" readonly>
                                                                            <span>Text Limit: <b id="image_title_limit">30</b></span>
                                                                        </td>
                                                                    </tr>
                                                                    <?php } ?>
                                    ...
                                    <table class="table table-bordered example2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalCoontentupdate<?php echo $content['content_id']?>"><i class="fa fa-pencil-square-o"></i></button>
                                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModalCoontent<?php echo $content['content_id']?>"><i class="fa fa-trash"></i></button>
                                                    <!----------------Update Model----------------------->
                                                    <div class="modal fade" id="myModalCoontentupdate<?php echo $content['content_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                <div class="modal-header">
                                                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  echo validation_errors();
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_trip_planner_content', $attributes);
                                                                  ?>
                                                                    ...
                                                                    <tr>
                                                                      ...
                                                                      <td>
                                                                        <?php
                                                                            echo $this->ckeditor->editor("textarea_title5",$content['title']);
                                                                        ?>
                                                                            <!-- <span>Text Limit: <b id="image_title_limit">30</b></span> -->
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                      <th><label for="Description" class="control-label">Description:</label></th>
                                                                      <td>
                                                                        <textarea class="form-control ckeditor" onkeypress="return onlyAlphabetsNumberschar(event,this);" onkeyup="add_image_title(event)" id="editor<?php echo $i;?>" name="description" required rows="3" cols="40"><?php echo $content['description']?></textarea>
                                                                            <!-- <span>Text Limit: <b id="image_title_limit">30</b></span> -->
                                                                        </td>
                                                                    </tr>
                                                                   <tr>
                                                    ...
                                                    <div class="modal fade" id="myModalCoontent<?php echo $content['content_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                              ...
                                                              <?php
                                                                  echo form_open('Admin/delete_trip_planner');
                                                                  ?>
                                                              <div class="modal-body">
                                                                <h4>Are you sure, You want to delete this Trip Planner Content ?</h4>
                                                              </div>
                                                              <div class="modal-footer">
                                                                <?php
                                                                 $encrypted_string = $this->encrypt->encode($content['content_id']);
...
<script type="text/javascript">
        document.getElementById('nav-trip_planner').className += " active";
    </script>
...
<!-----------------------Onload Popup-------------------->
    ...
    ?>
        <script>
        alert("Trip Planner Images has been updated successfully !");
        </script>
    ...
    ?>
        <script>
        alert("Trip Planner Content has been added successfully !");
        </script>
    ...
    ?>
        <script>
        alert("Trip Planner Content has been updated successfully !");
        </script>
