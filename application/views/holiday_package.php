                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                echo form_open('Admin/add_holiday_package',$attributes);
                                ?>
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <table class="table table-bordered">
                                  ...
                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                  echo form_open('Admin/update_holiday_image', $attributes);
                                  ?>
                                  <?php
                                  ...
                                  <tr>
                                      ...
                                      <td><img src="<?php echo base_url();?>uploads/holiday_images/<?php echo $rewards_image['image_path'];?>" height="250px" width="450px"></td>
                                  </tr>
                                  <tr>
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <table class="table table-bordered">
                                  ...
                                  echo validation_errors();
                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                  echo form_open('Admin/update_holiday_content', $attributes);
                                  ?>
                                  <?php
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo base_url();?>uploads/holiday_package/<?php echo $content['image']?>" height="100" width="100"/></td>
                                                <td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  echo validation_errors();
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_holiday_package', $attributes);
                                                                  ?>
                                                                    <tr>
                                                                      <th><label for="Title" class="control-label">Title:</label></th>
                                                ...
                                                <!----------------Delete Model----------------------->
                                                    <div class="modal fade" id="myModaldelete<?php echo $content['package_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog" role="document">
                                                          ...
                                                          <?php
                                                              echo form_open('Admin/delete_holiday_package');
                                                              ?>
                                                          <div class="modal-body">
...
<script type="text/javascript">
        document.getElementById('nav-holiday').className += " active";
</script>
...
<!-----------------------Onload Popup-------------------->
    ...
    ?>
        <script>
        alert("Holiday Package has been added successfully !");
        </script>
    ...
    ?>
        <script>
        alert("Holiday Package has been updated successfully !");
        </script>
    ...
    ?>
        <script>
        alert("Holiday Package has been deleted successfully !");
        </script>
