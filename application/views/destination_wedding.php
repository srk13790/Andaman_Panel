                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                echo form_open('Admin/add_destination_wedding',$attributes);
                                ?>
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo base_url();?>uploads/destination_wedding_images/<?php echo $banner['image_path']?>" width="50px" height="50px"></td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_destination_wedding_images', $attributes);
                                                                  ?>
                                                                    
                                                                    <tr>
                                                                      <th><label for="Carousel" class="control-label">Carousel:</label></th>
                                                                      <td>
                                                                        <img src="<?php echo base_url();?>uploads/destination_wedding_images/<?php echo $banner['image_path']?>" width="150px" height="150px"> 
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  echo validation_errors();
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_destination_wedding_content', $attributes);
                                                                  ?>
                                                                    <tr>
                                                         ...
                                                         <div class="modal fade" id="myModalfaqdelete<?php echo $content['content_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            ...
                                                            <?php
                                                                echo form_open('Admin/delete_destination_wedding_content');
                                                                ?>
                                                            <div class="modal-body">
...
<!-----------------------Onload Popup-------------------->
    ...
    ?>
        <script>
        alert("Destination Wedding Content has been deleted successfully !");
        </script>
