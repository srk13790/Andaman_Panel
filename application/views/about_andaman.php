                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Add About Andaman Content</h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control ckeditor" onkeypress="return onlyAlphabetsNumberschar(event,this);" onkeyup="add_image_title(event)" id="editor" name="description" required rows="3" cols="40"></textarea>
                                </div>
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="<?php echo base_url();?>uploads/about_andaman_images/<?php echo $banner['image_path']?>" width="50px" height="50px"></td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_aboutandaman_images', $attributes);
                                                                  ?>
                                                                    
                                                                    <tr>
                                                                      <th><label for="Carousel" class="control-label">Carousel:</label></th>
                                                                      <td>
                                                                        <img src="<?php echo base_url();?>uploads/about_andaman_images/<?php echo $banner['image_path']?>" width="150px" height="150px"> 
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade" id="myModalCoontent<?php echo $content['content_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                  ...
                                                                  echo validation_errors();
                                                                  $attributes = array('name' => 'form1','enctype' => 'multipart/form-data');
                                                                  echo form_open('Admin/update_about_andaman_content', $attributes);
                                                                  ?>
                                                                    <tr>
                                                        ...
                                                        <div class="modal fade" id="myModalfaqdelete<?php echo $content['content_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            ...
                                                            <?php
                                                                echo form_open('Admin/delete_aa');
                                                                ?>
                                                            <div class="modal-body">
...
<!-----------------------Onload Popup-------------------->
    ...
    ?>
        <script>
        alert("About Andaman Images has been updated successfully !");
        </script>
    ...
    ?>
        <script>
        alert("About Andaman Content has been added successfully !");
        </script>
    ...
    ?>
        <script>
        alert("About Andaman Content has been updated successfully !");
        </script>
    ...
    ?>
        <script>
        alert("About Andaman Content has been deleted successfully !");
        </script>
